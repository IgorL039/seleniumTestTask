...
public class Action6 {
    private static final String HOME_ELEMENT_X_PATH = "//div[@id='links-site']/ul/li/a[contains(., 'Home')]";
    ...
    public void Action6() {
        ...
        WebElement homeElement = driver.findElement(By.xpath(HOME_ELEMENT_X_PATH));
        homeElement.click();
        driver.quit();
    }
}
