...
public class Action5 {
    private static final String RESOURCES_FOR_MENU_ELEMENTS_X_PATH = "//div[@id='sidebar']/div/ul/li/ul/li";
    private static final String STUDENT_ELEMENT_X_PATH = "//div[@id='sidebar']/div/ul/li/ul/li[@class='active autonavItem parent']/span";
    ...
    public void Action5() {
        ...
        List<WebElement> resourcesForMenuElements = driver.findElements(By.xpath(RESOURCES_FOR_MENU_ELEMENTS_X_PATH));
        WebElement studentElement = driver.findElement(By.xpath(STUDENT_ELEMENT_X_PATH));
