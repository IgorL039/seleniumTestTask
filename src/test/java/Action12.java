...
public class Action12 {
    private static final String ELEMENT_INSTITUTIONS_X_PATH = "//div[@id='homepage-links']/ul/li[@class='resource-institutions']";
    ...
    public void Action12() {
        ...
        WebElement elementInstitutions = driver.findElement(By.xpath(ELEMENT_INSTITUTIONS_X_PATH));
